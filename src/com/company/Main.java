...
public class Main {
    ...
    private static void changePointAndDistance(Car car, int points, int distanse) {// реализуйте метод
        ...
        car.score += points;
        car.kilometersTravelled += distanse;
    }
    ...
    private static int makeRace(Car userCar, Car opponentCar, int distance) {
        ...
        if (shortRaceWin) { // если победил на короткой или на длинной дистанции
            System.out.println("Вы выиграли!");
            // Найдите и верните наибольшее из максимальных скоростей
            int maxSpeed1;
            if (userCar.maxSpeed > opponentCar.maxSpeed) maxSpeed1 =(int)userCar.maxSpeed;
            else maxSpeed1 = (int)opponentCar.maxSpeed;
            return maxSpeed1;
